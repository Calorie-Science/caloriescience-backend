        ...
        try {
          ...
          const result = await supabase
            ...
            .insert({
              ...
              eer_goal_calories: request.eerGoalCalories ?? null,
              protein_goal_min: request.proteinGoalMin ?? null,
              protein_goal_max: request.proteinGoalMax ?? null,
              carbs_goal_min: request.carbsGoalMin ?? null,
              carbs_goal_max: request.carbsGoalMax ?? null,
              fat_goal_min: request.fatGoalMin ?? null,
              fat_goal_max: request.fatGoalMax ?? null,
              fiber_goal_grams: request.fiberGoalGrams ?? null,
              water_goal_liters: request.waterGoalLiters ?? null,
