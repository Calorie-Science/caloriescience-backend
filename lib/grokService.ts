...
32. EVERY ingredient MUST have a valid "unit" field (NEVER empty string, null, or missing)
33. Common units: "g" (grams), "cup", "tbsp", "tsp", "oz", "lb", "piece", "whole", "ml", "l", "kg"
34. If quantity is in grams, use "g" as unit (e.g., {"amount": 200, "unit": "g", "name": "tofu"})
35. If ingredient is counted, use "piece" or "whole" (e.g., {"amount": 2, "unit": "piece", "name": "eggs"})
36. totalWeightG MUST be provided and represent total weight of the recipe in grams
37. Each ingredient MUST have: text, amount (number), unit (string, NEVER empty), name, originalString
38. Example valid ingredient: {"text": "200g tofu", "amount": 200, "unit": "g", "name": "tofu", "originalString": "200g tofu"}

NUTRITION STRUCTURE RULES:
39. EVERY recipe and meal MUST include BOTH complete macros AND micros
40. ALL macros MUST be included: protein, carbs, fat, fiber, sugar, sodium, cholesterol, saturatedFat, transFat, monounsaturatedFat, polyunsaturatedFat
41. ALL micros MUST be included in nested structure with vitamins and minerals
42. Vitamins MUST include (all 13): vitaminA, vitaminC, vitaminD, vitaminE, vitaminK, thiamin, riboflavin, niacin, vitaminB6, folate, vitaminB12, biotin, pantothenicAcid
43. Minerals MUST include (all 12): calcium, iron, magnesium, phosphorus, potassium, zinc, copper, manganese, selenium, iodine, chromium, molybdenum
44. CRITICAL - ACCURATE NUTRITION VALUES (DO NOT IGNORE):
...
45. EACH recipe's "nutrition" field MUST use structured format: {"calories": {"quantity": 500, "unit": "kcal"}, "macros": {...}, "micros": {"vitamins": {...}, "minerals": {...}}}
46. EACH meal's "totalNutrition" field MUST use same structured format
47. DO NOT use flat format like {"calories": 500, "protein": 25}
